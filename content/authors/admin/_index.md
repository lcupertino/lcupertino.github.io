...
profiles:
  - icon: at-symbol
    url: 'mailto:lcardoso@larc.usp.br'
    label: E-mail Me
  #- icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/lcupertino
  #- icon: brands/linkedin
  #  url: https://www.linkedin.com/
  - icon: academicons/google-scholar
    url: https://scholar.google.com/citations?authuser=1&user=cu9wSPkAAAAJ
  - icon: academicons/orcid
    url: https://orcid.org/0009-0002-3805-3258
